...
###############################################
PROJ = as4 # the name of the project
...
O_FILES := list.o StereoToMono.o mix.o chop.o reverse.o similarity.o encryption.o decryption.o slow.o ff.o readWav.o wave.o 
C_FILES := $(wildcard *.c)
